...
pub struct Take {
          ...
          pub taker_ata_a: solana_program::pubkey::Pubkey,
          
              
          pub taker_ata_b: solana_program::pubkey::Pubkey,
          
              
          pub maker_ata_b: solana_program::pubkey::Pubkey,
                /// Programs
...
impl Take {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = borsh::to_vec(&TakeInstructionData::new()).unwrap();
...
///
          ...
          ///   4. `[]` mint_b
                ///   5. `[writable]` vault
                ///   6. `[writable]` taker_ata_a
                ///   7. `[writable]` taker_ata_b
                ///   8. `[writable]` maker_ata_b
...
pub struct TakeBuilder {
            taker: Option<solana_program::pubkey::Pubkey>,
                ...
                taker_ata_a: Option<solana_program::pubkey::Pubkey>,
                taker_ata_b: Option<solana_program::pubkey::Pubkey>,
                maker_ata_b: Option<solana_program::pubkey::Pubkey>,
...
#[inline(always)]
    ...
    pub fn vault(&mut self, vault: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn taker_ata_a(&mut self, taker_ata_a: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.taker_ata_a = Some(taker_ata_a);
                    self
    }
            #[inline(always)]
    pub fn taker_ata_b(&mut self, taker_ata_b: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.taker_ata_b = Some(taker_ata_b);
                    self
    }
            #[inline(always)]
    pub fn maker_ata_b(&mut self, maker_ata_b: solana_program::pubkey::Pubkey) -> &mut Self {
...
#[inline(always)]
  ...
  pub struct TakeCpiAccounts<'a, 'b> {
              ...
              pub taker_ata_a: &'b solana_program::account_info::AccountInfo<'a>,
                
                    
              pub taker_ata_b: &'b solana_program::account_info::AccountInfo<'a>,
                
                    
              pub maker_ata_b: &'b solana_program::account_info::AccountInfo<'a>,
                        /// Programs
...
#[inline(always)]
    ...
    pub fn vault(&mut self, vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn taker_ata_a(&mut self, taker_ata_a: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.taker_ata_a = Some(taker_ata_a);
                    self
    }
      #[inline(always)]
    pub fn taker_ata_b(&mut self, taker_ata_b: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.taker_ata_b = Some(taker_ata_b);
                    self
    }
      #[inline(always)]
    pub fn maker_ata_b(&mut self, maker_ata_b: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          taker_ata_a: self.instruction.taker_ata_a.expect("taker_ata_a is not set"),
                  
          taker_ata_b: self.instruction.taker_ata_b.expect("taker_ata_b is not set"),
                  
          maker_ata_b: self.instruction.maker_ata_b.expect("maker_ata_b is not set"),
...
struct TakeCpiBuilderInstruction<'a, 'b> {
  __program: &'b solana_program::account_info::AccountInfo<'a>,
            taker: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                ...
                taker_ata_a: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                taker_ata_b: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                maker_ata_b: Option<&'b solana_program::account_info::AccountInfo<'a>>,
