...
export function getMakeInstructionDataEncoder(): Encoder<MakeInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', fixEncoderSize(getBytesEncoder(), 1)],
      ['seed', getU64Encoder()],
      ['recieve', getU64Encoder()],
...
export function getMakeInstructionDataDecoder(): Decoder<MakeInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 1)],
    ['seed', getU64Decoder()],
    ['recieve', getU64Decoder()],
    ['amount', getU64Decoder()],
  ]);
}

export function getMakeInstructionDataCodec(): Codec<
...
> = {
  ...
  recieve: MakeInstructionDataArgs['recieve'];
